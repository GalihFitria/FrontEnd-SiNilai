                ...
                <ul>
                    ...
                    <li class="mb-4 relative">
                        ...
                        <ul id="dropdown-menu" class="hidden bg-blue-600 mt-2 rounded-lg">
                            ...
                            <li><a href="{{route('kelas.index')}}" class="block px-4 py-2 hover:bg-blue-700 active-link">Data Kelas</a></li>
                    ...
                    <tbody id="kelasTable">
                        ...
                        <tr>
                            ...
                            <td class="border p-2 text-center">
                                ...
                                <form action="{{route('kelas.destroy',$k['kode_kelas'])}}" method="post">
                                    @csrf
                                    @method('DELETE')
