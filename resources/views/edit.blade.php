        ...
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <form action="{{ route('nilai.update', $penilaian['id_nilai']) }}" method="post">
                ...
                <select name="npm" class="border w-full p-2 mb-2 rounded text-sm">
                    ...
                    <option value="{{ $row['npm'] }}" {{ $penilaian['npm'] == $row['npm'] ? 'selected' : '' }}>
                        {{ $row['npm'] }}
                    </option>
                    @endforeach
                </select>
                ...
                <select name="kode_matkul" class="border w-full p-2 mb-2 rounded text-sm">
                    ...
                    <option value="{{ $row['kode_matkul'] }}" {{ $penilaian['kode_matkul'] == $row['kode_matkul'] ? 'selected' : '' }}>
                        {{ $row['nama_matkul'] }}
                    </option>
                    @endforeach
                </select>
                ...
                <select name="nidn" class="border w-full p-2 mb-2 rounded text-sm">
                    ...
                    <option value="{{ $row['nidn'] }}" {{ $penilaian['nidn'] == $row['nidn'] ? 'selected' : '' }}>
                        {{ $row['nama_dosen'] }}
                    </option>
                    @endforeach
                </select>
